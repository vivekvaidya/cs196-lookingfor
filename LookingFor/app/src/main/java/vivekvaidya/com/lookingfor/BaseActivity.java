...
public class BaseActivity extends AppCompatActivity{ //changed from depricated ActionBarActivity
    ...
    public void set(String[] navMenuTitles, TypedArray navMenuIcons) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this, mDrawerLayout,
                ...
                R.string.appbar_scrolling_view_behavior, // nav drawer open - description for accessibility
    ...
    private void displayView(int position) {
        ...
        switch (position) {
            ...
            case 0:
                ...
                Intent intent = new Intent(this, EventBrowserDrawer.class);
